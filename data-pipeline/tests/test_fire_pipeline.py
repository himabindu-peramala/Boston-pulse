...
from preprocess_fire import preprocess_fire_data, generate_statistics, categorize_incident_severity
...
def sample_raw_data(tmp_path):
    data = {
        ...
        'Property Description': ['Multifamily', 'Mercantile', 'Multifamily', 'Multifamily', 'Residential'],
...
def sample_processed_data(tmp_path):
    data = {
        ...
        'District': ['7', '9', '7', '3', '9'],
        'Neighborhood': ['ROXBURY', 'HYDE PARK', 'ROXBURY', 'DORCHESTER', 'HYDE PARK'],
        'alarm_datetime': ['2013-01-01 00:04:38', '2013-01-01 01:15:00',
                           '2013-01-02 14:30:00', '2013-01-02 22:00:00', '2013-01-03 08:45:00'],
...
class TestPreprocessFireData:
    ...
    def test_feature_columns_added(self, sample_raw_data, tmp_path):
        ...
        expected = ['severity_category', 'total_loss', 'has_loss',
                    'time_of_day', 'is_weekend', 'district_incident_count']
        for col in expected:
...
class TestGenerateFireStatistics:
    ...
    def test_returns_expected_keys(self, sample_processed_data):
        ...
        for key in ['total_records', 'severity_distribution', 'district_distribution', 'total_property_loss']:
            assert key in stats
