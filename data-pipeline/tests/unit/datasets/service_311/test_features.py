        ...
        return pd.DataFrame(
            {
                ...
                "open_date": [
                    ...
                    datetime(2024, 1, 1, 10, 0), # Older record
                ],
...
def test_build_311_features_convenience(sample_processed_data):
    """Test convenience function."""
    result = build_311_features(sample_processed_data, execution_date="2024-01-15")
    assert result["success"]
    # builder.run returns a Result object which has rows_processed
