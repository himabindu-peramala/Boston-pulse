...
class TestCityScorePreprocessor:
        ...
        return pd.DataFrame(
            {
                ...
                "score_date": ["2024-01-15T00:00:00", "2024-01-15T00:00:00", "2024-01-16T00:00:00", "2024-01-15T00:00:00"],
                "metric": ["Trash On-Time %", "Pothole On-Time %", "Trash On-Time %", "Trash On-Time %"],
                "score": [0.85, 0.92, 0.88, 0.85],
    ...
    def test_datetime_parsing(self, preprocessor, sample_raw_data):
        ...
        assert pd.api.types.is_datetime64_any_dtype(df["score_date"])
...
def test_preprocess_cityscore_data_convenience(sample_raw_data):
